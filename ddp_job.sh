...
echo "[JOB] Running job with $SLURM_NNODES nodes on ${SLURMD_NODENAME}"
...
export PYTHONUNBUFFERED=1 # Disable buffering output (sometimes needed with SLURM)
...
# TODO: Only if this is the main node
